...
import { DataTableReporteRecoridos } from "./DataTableReporteRecoridos";
import { getReportsRecorridos } from "@/lib/Reportes";
...
export function DatosFechaReporteRecoridos() {
    ...
    async function onSubmit(values: z.infer<typeof formSchema>) {
      try {
            ...
            await getReportsRecorridos(setLoading, {
    ...
    return (
      <Form {...form}>
        ...
        <DataTableReporteRecoridos data={data} setData={setData}/>
      </Form>
    )
}
