...
import { crearSolicitudGrupos } from "@/lib/Solicitudes"
...
export const DatosCrearSolicitudGrupos = ({ }) => {
    ...
    async function onSubmit(values: FormValues) {
        ...
        try {
            ...
            const GrupoIds = empleados.id;
            const requestData = {
                id_user_solicitante: user.id,
                //id_he_empleado_trabajador:2,
                clave: `${GrupoIds}${generateRandomLetters(3)}${values.horas}${generateRandomLetters(3)}`,
            ...
            <div className="ml-10 mr-10">
                <div className="w-full space-x-4 flex mb-5">
                    ...
                    {dataEmpleados.length === 0 &&
                        <p className="text-red-500 text-sm">Debe seleccionar un grupo</p>
                    }
                </div>
                <Form {...form}>
