  ...
  return (
    <AlertDialog>
      <AlertDialogTrigger asChild>
        <Button variant="outline" className={`${status == 0 ? "text-green-500 hover:text-green-800":"text-red-500 hover:text-red-800"}`}>{status == 0 ? 'Activar':'Desactivar'}<MdOutlineCancel /></Button>
      </AlertDialogTrigger>
      <AlertDialogContent>
        <AlertDialogHeader>
