...
import { importarValvulas } from "@/lib/ValvulasService";

export function ModalImportarValvulas() {
  ...
  return (
    <AlertDialog>
      <AlertDialogTrigger asChild>
        <Button variant="outline" className="border-none ml-1">Importar Valvulas</Button>
      </AlertDialogTrigger>
      <AlertDialogContent>
        <AlertDialogHeader>
        ...
        <AlertDialogFooter>
          ...
          <Button
            ...
            onClick={async () => {
              try {
                await importarValvulas(setLoading, fileContent);
